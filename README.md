          ...
          - - Lightweight browser demo UI
            - - Validation scripts and sensitivity sweep for public-release safety
              - - MIT License, CONTRIBUTING guide, SECURITY policy
                ...
                - The 500 curated profiles in `agents/public-curated-500/` are derived from a private library of 16,113 agents. The curation pipeline audited 1,689 public-safe candidates and selected 500 for this release. Every profile is transformed to exclude internal prompts, customer records, credentials, and operational fields. See `agents/public-curated-500/README.md` for the full release policy.
